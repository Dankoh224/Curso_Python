...
# Y otra cosita que no sabíamos, es que podemos alinear nuestro texto de salida en la cantidad de espacios que necesitemos. Ejemplo a la izquierda y derecha:
print("{:<12} Justificado a la izquierda.".format("12"))
print("{:>12} Justificado a la derecha.".format("12"))

# Ejemplo al centro:
print("{:12} Centrado.".format("12".center(12," ")))